...
The difficulty sharpens for a speaker whose Chinese dialect group is Hockchia (Fuzhou/Fuqing), the smallest one separately identified in Singapore's census (17,070 people or ~0.57% of the Chinese population in 2020). The major substrates feeding Singlish's connected-speech patterns—Hokkien/Minnan, Teochew, Cantonese, Malay, Tamil—are not the speaker's home variety. Bao (2015) argues that much of Singlish's distinctive grammar and phonology reflects substrate transfer from Southern Chinese varieties, with Hokkien features disproportionately prominent. A speaker from a non-Hokkien background may therefore hear local connected-speech features without having the substrate phonology that makes them feel natural. The advice to "just speak local English naturally" assumes a shared linguistic substrate that is not present. Local patterns for final consonant timing, glottal usage, and release may be as phonologically unfamiliar as RP or GA patterns, just unfamiliar in a different direction—not foreign in the sense of imported, but foreign in the sense of built on a different substrate.
