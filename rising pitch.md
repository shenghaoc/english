...
There is an irony in the observation itself. A speaker from the Hockchia dialect group—the smallest one separately identified in Singapore's census (17,070 people or ~0.57% of the Chinese population in 2020)—may notice the Minnan-like quality of local English intonation more readily precisely because they are not Minnan speakers. Insiders to a phonological system process its patterns automatically and transparently; outsiders notice them because the patterns do not match their own baseline. This is a specific case of the asymmetry documented in perceptual dialectology: people are most aware of features that differ from their own system and least aware of features that match it (Preston, 1999). The observation about Minnan-influenced intonation is therefore both valid and positionally specific—it is an insight available to someone who stands outside the dominant substrate, not a universal fact that all Singapore English speakers would report. A Hokkien-dominant speaker might find the same intonation unremarkable precisely because it matches their own prosodic habits, illustrating once more that everybody has an accent and nobody hears their own baseline as marked.
