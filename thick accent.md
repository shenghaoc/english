...
- [enunciated](pronunciation/enunciated.md) — vowel reduction and stress-timing
- [glottal stops](<pronunciation/glottal stops.md>) — liaison, linking, and word-boundary marking
- [rising pitch](<pronunciation/rising pitch.md>) — declarative intonation

For dialect ecology and personal background, see [dialect groups](<context/dialect groups.md>) and [tonal character](<context/tonal character.md>). For the learner's input-distribution problem, see [the answer](<the answer.md>).

---

## 1. Full enunciation of unstressed syllables

English is stress-timed in organization: stressed syllables are the rhythmic anchors, and unstressed syllables between them are compressed and reduced to fit (Dauer, 1983; Grabe & Low, 2002). The primary mechanism is vowel reduction — unstressed vowels collapse toward schwa /ə/ or are elided. This is not carelessness; it is the engine of English rhythm.

- `today` → /tə.ˈdeɪ/, not /tuː.ˈdeɪ/
- `photograph` → /ˈfəʊ.tə.ɡrɑːf/, not /ˈfəʊ.toʊ.ɡræf/
...
When a word ending in a consonant is followed by a word beginning with a vowel, RP and GA resyllabify: the coda consonant moves to become the onset of the following syllable. This is liaison or consonant-to-vowel linking — a categorical, rule-governed feature of fluent English (Nolan, 1992; Cruttenden, 2014).

- `find it` → /faɪn.dɪt/, not /faɪnd/ + /ɪt/
- `sort out` → /sɔː.taʊt/, not /sɔːt/ + /aʊt/
- `link up` → /lɪŋ.kʌp/, not /lɪŋk/ + /ʌp/
...
For a learner whose input is mostly RP/GA media and ambient Singlish, with almost no stable SSE target, the practical problem is not choosing between "good" and "bad" English but recognizing that three locally valorised features are structurally opposed to the documented norms of the prestige varieties he can actually study. See [the answer](<the answer.md>).
...
- Dragojevic, M., & Giles, H. (2016). "I don't like you because you're hard to understand." *Human Communication Research*, 42(3), 396-420. https://doi.org/10.1111/hcre.12079
...
- Grabe, E., & Low, E. L. (2002). "Durational variability in speech and the rhythm class hypothesis." In C. Gussenhoven & N. Warner (Eds.), *Papers in Laboratory Phonology 7* (pp. 515-546). Mouton de Gruyter.
- Harrington, J., Palethorpe, S., & Watson, C. (2000). "Monophthongal vowel changes in Received Pronunciation." *Journal of the International Phonetic Association*, 30(1-2), 63-78. https://doi.org/10.1017/S0025100300006666
...
- Nolan, F. (1992). "The descriptive role of segments: Evidence from assimilation." In G. J. Docherty & D. R. Ladd (Eds.), *Papers in Laboratory Phonology II* (pp. 261-280). Cambridge University Press.
